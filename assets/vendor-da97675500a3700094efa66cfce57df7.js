...
if(g)for(n.handler&&(o=n,n=o.handler,i=o.selector),i&&de.find.matchesSelector(Ye,i),n.guid||(n.guid=de.guid++),(u=g.events)||(u=g.events={}),(s=g.handle)||(s=g.handle=function(t){return void 0!==de&&de.event.triggered!==t.type?de.event.dispatch.apply(e,arguments):void 0}),t=(t||"").match(Re)||[""],c=t.length;c--;)a=Je.exec(t[c])||[],h=m=a[1],d=(a[2]||"").split(".").sort(),h&&(p=de.event.special[h]||{},h=(i?p.delegateType:p.bindType)||h,p=de.event.special[h]||{},l=de.extend({type:h,origType:m,data:r,handler:n,guid:n.guid,selector:i,needsContext:i&&de.expr.match.needsContext.test(i),namespace:d.join(".")},o),(f=u[h])||(f=u[h]=[],f.delegateCount=0,p.setup&&!1!==p.setup.call(e,r,d,s)||e.addEventListener&&e.addEventListener(h,s)),p.add&&(p.add.call(e,l),l.handler.guid||(l.handler.guid=n.guid)),i?f.splice(f.delegateCount++,0,l):f.push(l),de.event.global[h]=!0)},remove:function(e,t,n,r,i){var o,s,a,u,c,l,p,f,h,d,m,g=De.hasData(e)&&De.get(e)
...
function t(){var e=Object.create(null)
return e._dict=null,delete e._dict,e}Object.defineProperty(e,"__esModule",{value:!0}),e.default=t}),define("ember-stylish-buttons/components/stylish-button",["exports","ember-stylish-buttons/templates/components/stylish-button"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
var n=Ember.computed
e.default=Ember.Component.extend({layout:t.default,tagName:"button",classNames:["button"],classNameBindings:["buttonStyle","buttonBorder","buttonShape","upperCase:button--text-upper","inverted:button--inverted","invertedAlt:button--inverted-alt","buttonTextWidth","buttonSize","customClasses"],attributeBindings:["text:data-text"],buttonStyle:n("type",function(){return"button--"+this.get("type")}),buttonBorder:n("border",function(){return"button--border-"+this.get("border")}),buttonShape:n("shape",function(){return this.get("shape")?"button--"+this.get("shape"):""}),buttonSize:n("size",function(){return this.get("size")?"button--size-"+this.get("size"):""}),buttonTextWidth:n("textWidth",function(){return this.get("textWidth")?"button--text-"+this.get("textWidth"):""}),click:function(){this.get("action").apply(void 0,arguments)}})}),define("ember-stylish-buttons/templates/components/stylish-button",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"rWtpT/XA",block:'{"symbols":["&default"],"statements":[[4,"if",[[22,1]],null,{"statements":[[0,"  "],[11,1],[0,"\\n"]],"parameters":[]},{"statements":[[0,"  "],[6,"span"],[7],[0,"\\n    "],[1,[18,"text"],false],[0,"\\n  "],[8],[0,"\\n"]],"parameters":[]}],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"ember-stylish-buttons/templates/components/stylish-button.hbs"}})})
